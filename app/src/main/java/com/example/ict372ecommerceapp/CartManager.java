...
public class CartManager {
    ...
    public void addToCart(int productId, String productName, String productPrice,
                          int imageResId, String selectedColor, int quantity) {
        ...
        if (existingItem != null) {
            ...
            CartItem newItem = new CartItem(productId, productName, productPrice,
                    imageResId, selectedColor, quantity);
    ...
    private CartItem findItem(int productId, String color) {
        for (CartItem item : cartItems) {
            String itemColor = item.selectedColor != null ? item.selectedColor : "";
            String searchColor = color != null ? color : "";
            if (item.productId == productId && itemColor.equals(searchColor)) {
                return item;
            }
        }
        return null;
    ...
    private void saveCart() {
        try {
            ...
            for (CartItem item : cartItems) {
                ...
                jsonObject.put("imageResId", item.imageResId);
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                CartItem item = new CartItem(
                        ...
                        jsonObject.optInt("imageResId", 0),
